...
export default function BoardWriteUi(props) {
    ...
    <S.Wrapper>
                ...
                <S.WriterWrapper>
                    <S.InputWrapper>
                        <S.Label>작성자</S.Label>
                        <S.Writer type='text' placeholder='이름을 적어주세요.' onChange={props.onChangeWriter}></S.Writer>
                        <S.Error>{props.writerError}</S.Error>
                    </S.InputWrapper>
                    <S.InputWrapper>
                        <S.Label>비밀번호</S.Label>
                        <S.Password type='password' placeholder='비밀번호를 작성해주세요.' onChange={props.onChangePassword}></S.Password>
                        <S.Error>{props.passwordError}</S.Error>
                    </S.InputWrapper>
                </S.WriterWrapper>
                <S.InputWrapper>
                    <S.Label>제목</S.Label>
                    <S.Subject type='text' placeholder='제목을 작성해주세요.' onChange={props.onChangeSubject}></S.Subject>
                    <S.Error>{props.subjectError}</S.Error>
                </S.InputWrapper>
                <S.InputWrapper>
                    <S.Label>내용</S.Label>
                    <S.Contents type='text' placeholder='내용을 작성해주세요.' onChange={props.onChangeContents}></S.Contents>
